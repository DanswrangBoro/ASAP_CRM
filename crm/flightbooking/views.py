    ...
    if request.method == "GET":
        try:
            ...
            #     # uncomment this is production-------------------------------------
                ...
                return render(request,'flight_result.html',{"data":json.dumps(context)})
                # uncomment this is production-------------------------------------
...
def multiCitySearch(request):
    if request.method == "POST":
        ...
        return render(request,"flight_multi_result.html",context)


# Auto complete City and Airport Name
def origin_search(request):
    print("origin search called")
    if request.method=='GET':
        try:
...
def customCredentials(request):
    ...
    try:
        ...
        return render(request, 'flight_customer.html', context)
    except Exception as e:
        json_data = {}
        print(f"Error: {e}")
        error_message = {"error": str(e)}
